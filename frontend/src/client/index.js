...
export const LoginService = {
  loginAccessToken: async () => ({ success: false, error: "API not available" }),
...
export const UsersService = {
  readUsers: async () => ({ success: false, data: [], error: "API not available" }),
...
export const ItemsService = {
  readItems: async () => ({ success: false, data: [], error: "API not available" }),
